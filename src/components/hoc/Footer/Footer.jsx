...
const Footer = (props) => {
  ...
  return (
    <>
      <footer className="md:w-1/5 mdl:w-1/4 lg:w-1/3 mdl:static footer px-5 py-1 md:text-center border-t md:border-t-0 border-gray-700 fixed bottom-0 left-0 right-0  md:left-0 md:bottom-0 bg-primary-700 md:top-0 md:border-r md:border-gray-700 z-30">
        <div className="flex md:flex-col md:items-baseline md:space-y-2 flex-row space-y-0 justify-between items-center md:inline-block">
          <ActiveLink href="/">
            <a className="hidden hover:bg-secondary-200 hover:text-secondary-700 md:inline-block p-2 rounded-md">
              <svg
                viewBox="0 0 512 512"
                className="hover:text-secondary-700 fill-current stroke-current text-blue-600 h-6 w-6 lg:h-7 lg:w-7"
              >
          ...
          <ActiveLink href="/accueil" activeClassName="text-secondary-700">
            <a className="group hover:bg-secondary-200 hover:text-secondary-700 flex space-x-3 p-2 rounded-md">
              <svg
                ...
                className="group-hover:text-secondary-700 fill-current stroke-current h-6 w-6 lg:h-7 lg:w-7"
              >
              ...
              <span className="hidden lg:inline font-bold">Accueil</span>
            </a>
          </ActiveLink>
          {/*second icon */}
          <ActiveLink href="/explore" activeClassName="text-secondary-700">
            <a className="group hover:bg-secondary-200 hover:text-secondary-700 flex space-x-3 p-2 rounded-md">
              ...
              <span className="hidden lg:block font-bold">Explorer</span>
            </a>
          </ActiveLink>
          {/*second icon */}
          ...
          <ActiveLink href="/signet" activeClassName="text-secondary-700">
            <a className="group hidden hover:bg-secondary-200 hover:text-secondary-700 md:flex space-x-3 p-2 rounded-md">
              <svg
                activeClassName="text-secondary-700"
                className="group-hover:text-secondary-700 fill-current stroke-current w-6 h-6 md:inline-block lg:h-7 lg:w-7"
                fill="none"
                stroke="currentColor"
                viewBox="0 0 24 24"
              >
              ...
              <span className="hidden lg:block font-bold">Signets</span>
            </a>
          </ActiveLink>
          <ActiveLink href="/list" activeClassName="text-secondary-700">
            <a className="group hidden hover:bg-secondary-200 hover:text-secondary-700 md:flex space-x-3 p-2 rounded-md">
              <svg
                activeClassName="text-secondary-700"
                viewBox="0 0 24 24"
                className="group-hover:text-secondary-700 fill-current stroke-current w-6 h-6 hidden md:inline-block lg:h-7 lg:w-7"
              >
              ...
              <span className="hidden lg:block font-bold">Listes</span>
            </a>
          </ActiveLink>
          <ActiveLink href="/profil" activeClassName="text-secondary-700">
            <a className="group hidden hover:bg-secondary-200 hover:text-secondary-700 md:flex space-x-3 p-2 rounded-md">
              ...
              <span className="hidden lg:block font-bold">Profil</span>
            </a>
          </ActiveLink>
          <ActiveLink href="/more" activeClassName="text-secondary-700">
            ...
            >
              ...
              <span className="hidden lg:block font-bold">Plus</span>
            </a>
          </ActiveLink>
          <button className="hidden md:static md:mt-2 fixed bottom-0 right-0 mr-4 h-13 w-13 md:h-10 md:max-w-sm md:w-full md:rounded-lg bg-secondary-700 text-white lg:flex items-center justify-center focus:outline-none">
            <Link href="/accueil/#addPost">
              <a>Tweeter</a>
            </Link>
          </button>
          <button className="lg:hidden flex md:static md:mt-2 fixed bottom-16 right-0 mr-4 w-10 h-10 rounded-full bg-secondary-700 text-white md:flex items-center justify-center focus:outline-none">
            <a href="#addPost">
              <svg
                viewBox="0 0 24 24"
        ...
        <Menu>
          <button
            ...
            className="relative hidden md:mx-auto focus:outline-none md:flex flex-row space-x-2 items-center p-2 bg-brand-700 rounded-md hover:bg-secondary-200 mt-20"
          >
            <img
              src={user?.image}
              alt={user?.name}
