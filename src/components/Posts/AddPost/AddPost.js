...
const AddPost = (props) => {
  ...
  return (
    <div className="bg-primary-700 p-3 md:flex items-start flex-row space-x-3 mt-2 md:mt-20 hidden w-full">
      <img
      ...
      <div className="flex-1 mt-6">
        <form onSubmit={handleSubmit} autoComplete="false">
          ...
          <div className="flex flex-row mt-4">
            <div className="w-1/2 ">
              <button
                className="focus:outline-none hover:bg-secondary-200 p-1 rounded-md"
                id="customBtn"
