...
const SinglePost = ({ post, posts }) => {
  ...
  return (
    <Link href={`/post/${post?._id}`}>
      <a
        key={post?._id}
        className="block px-4 pt-3 pb-4 border-b border-gray-700 cursor-pointer hover:bg-secondary-200 transition ease-in-out duration-150"
      >
              ...
              {post.image ? (
                <>
                  <div
                    ...
                    className="relatiive transform group-hover:scale-105 ease-in-out duration-150 transition cursor-pointer overflow-hidden border border-gray-700 h-56 w-full rounded-md"
                  >
        ...
        <div className="flex items-baseline justify-between flex-row pt-5 mx-auto sm:w-2/3">
          ...
          {/* Retweet */}
          <div onClick={() => handleRetweet(post)} className="cursor-pointer">
            {post?.retweets?.includes(userId) ? (
          ...
          {/* Likes */}
          <div onClick={() => handleLikes(post)} className="cursor-pointer">
          ...
          {/* Share */}
          <div onClick={() => handleShare(post)} className="cursor-pointer">
